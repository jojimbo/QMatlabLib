classdef GenEGB2 < prursg.Engine.Model    
    ...
    methods
        function obj = GenEGB2(initValue, parameters )
            % Constructor
            obj = obj@prursg.Engine.Model('GenEGB2');
        end
        ...
        function series = simulate(obj, workerObj, corrNumElements)
            series = obj.mu - obj.sigma * log(1./betainv(normcdf(corrNumElements),obj.alpha,obj.beta)-1);
        end
