classdef EquityEGB2 < prursg.Engine.Model    
    ...
    methods
        function obj = EquityEGB2()
            % Constructor
            obj = obj@prursg.Engine.Model('EquityEGB2');
        end
        ...
        function series = simulate(obj, workerObj, corrNumElements)
            ...
            series = obj.initialValue.values{1}.*(1+drift).* exp(obj.mu - obj.sigma .* log(1./betainv(normcdf(corrNumElements),obj.alpha,obj.beta)-1));
        end
