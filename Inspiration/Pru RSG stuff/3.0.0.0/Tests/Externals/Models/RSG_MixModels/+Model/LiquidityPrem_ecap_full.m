classdef LiquidityPrem_ecap_full < prursg.Engine.Model    
    ...
    methods
        function obj = LiquidityPrem_ecap_full()
            % Constructor
            obj = obj@prursg.Engine.Model('LiquidityPrem_ecap_full');
        end
        ...
        function series = simulate(obj, workerObj, corrNumElements)
            ...
            lqp = obj.mult*(spdAAA(:,1)*obj.wAAA + spdAA(:,1)*obj.wAA + spdA(:,1)*obj.wA + spdBBB(:,1)*obj.wBBB + spdBB(:,1)*obj.wBB + spdB(:,1)*obj.wB + ...
                ...
                rmbs_spdB(:,1)*obj.wrmbs_B + rmbs_spdBB(:,1)*obj.wrmbs_BB +rmbs_spdBBB(:,1)*obj.wrmbs_BBB- obj.deduct);
