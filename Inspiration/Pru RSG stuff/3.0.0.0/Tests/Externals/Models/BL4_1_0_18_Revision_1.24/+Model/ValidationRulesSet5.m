classdef ValidationRulesSet5 < prursg.Engine.ValidationRules
    ...
    methods
        function obj = ValidationRulesSet5()
...
function resultFileName = Process(obj, batchIndex, risks, scenarioSet, stoValues, reportPath)
    ...
    rowSize = nSubRisks;
    colSize = length(detScenarios) + 3001;  % 3001 buckets
