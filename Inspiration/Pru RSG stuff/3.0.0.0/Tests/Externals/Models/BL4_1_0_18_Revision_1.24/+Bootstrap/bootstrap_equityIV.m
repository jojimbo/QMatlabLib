...
% _Data Type_: double
%
% *|[LTEquityReturnEstimate]|* - $\mu_A$, the estimate return in the long term
%
% _Data Type_: double
%
% *|[LTEquityStdDev]|* - $\sigma_A$, the arithmatic volatility in the long term
%
% _Data Type_: double
%
...
% _Data Type_: double
%
% *|[startterm]|* - defines the start term of the ouput
%
% _Data Type_: double
%
% *|[endterm]|* - defines the end term of the ouput
%
% _Data Type_: double
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    properties
        ...
        LTEquityReturnEstimate
        LTEquityStdDev
        LTEquityEstimateType
        ExpDecayFactor
        % Liquidity Points
        llpMaturity
        llpminStrike
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
 ...
 %%%% STEP 1: Create Extrapolation Object %%%%
   newEquityVolextrap = Bootstrap.bsEquityForwardVolExtrapolation ...
      (obj.LTEquityReturnEstimate, obj.LTEquityStdDev, ...
       obj.LTEquityEstimateType,obj.ExpDecayFactor, ...
   ...
   % NewStrikeMoneyness = newobject.createArrayfromCSVstring(obj.Moneyness);
    eval (['NewStrikeMoneyness=[' obj.Moneyness '];']);
 ...
 %%%% STEP 5: Convert Forward Vols to Spot vols if necessary %%%%
   if strcmp( DataSeriesIn(1).volatility_type , 'fwdvols')
       for i=1:inumberOfDates
           VolatilitySurface{i,1}=newEquityVolextrap. ...
               CreateSpotVolSurfaceFromFwdVolSurface...
 ...
 %%%% STEP 6: Forward Strike Adjustment if necessary %%%%
   if strcmp( obj.newDataSeriesObject(1).strike_type, 'spotstrike') && ...
       ...
       for i=1: inumberOfDates
          ...
          newForwardStrikeBasis = Bootstrap.bsEquityStrikeBasis ...
             (VolatilitySurface{i,1}, OptionMaturities, OptionStrikes,...
              ForwardIndexPrices, ForwardIndexMaturities, ...
              NewStrikeMoneyness);
      ...
      OptionStrikes= NewStrikeMoneyness;
 ...
 %%%% STEP 7: Calculate values %%%%             
   for i=1:  inumberOfDates
      newsurface = newEquityVolextrap.CreateExtrapolatedSurface ...
          (VolatilitySurface{i,1}, OptionMaturities, OptionStrikes, ...
           obj.ouputfrequencyprofile, NewStrikeMoneyness, ...
           obj.Methods{2},obj.StrikeMethod);  

     if  strcmp(obj.Methods{1}, 'spotstrike') && ~strcmp(obj.Methods{1},...
             'stddev') && (numOfDataSeries > 1);
