...
% series for a certain compounding frequncy, $f$, with output frequency 
% given by *|[outputfreq]|*.
...
%
% Depending whether we have continuous or discrete compounding the spot 
% rates are calculate using:
%%
% i) Continuous Compounding 
%
% $$ S(t,T) = -\frac{ln(B(t,T))}{T-t} $$
%
% where
%
