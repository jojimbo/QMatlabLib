...
%MATLAB CODE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%         
    function CreateNewIVMatrixReturn = CreateNewIVMatrix(obj, ...
            newStrikeType,Truncate) 

      [CurrStrikes,NewStrikes] = obj.CreateStrikeMatrix(newStrikeType);
      newLinearInterp = Bootstrap.bsLinearInterpolation();

      CreateNewIVMatrixReturn = newLinearInterp.LinearMatrix(NewStrikes,...
          CurrStrikes,obj.IVs,Truncate);            
