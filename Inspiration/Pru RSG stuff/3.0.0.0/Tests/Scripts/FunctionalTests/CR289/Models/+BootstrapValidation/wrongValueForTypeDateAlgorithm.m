classdef wrongValueForTypeDateAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = wrongValueForTypeDateAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
            ...
            validationResults.AddCustomProperty('date', 'firstDate', 'testing');
        end
    end
