classdef invalidDataSeriesAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = invalidDataSeriesAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
           ...
           validationResults.AddResults('table', 'table1', {1,2,3;'chris',4,'bla'});
        end
    end
