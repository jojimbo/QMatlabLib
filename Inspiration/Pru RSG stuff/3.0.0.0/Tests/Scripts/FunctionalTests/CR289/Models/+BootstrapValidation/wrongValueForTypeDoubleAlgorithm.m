classdef wrongValueForTypeDoubleAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = wrongValueForTypeDoubleAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
            ...
            validationResults.AddResults('double', 'daysInFiveCompoundingPeriods', 'testing');
