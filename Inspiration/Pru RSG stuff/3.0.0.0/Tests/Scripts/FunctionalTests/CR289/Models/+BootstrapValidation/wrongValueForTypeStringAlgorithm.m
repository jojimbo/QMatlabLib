classdef wrongValueForTypeStringAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = wrongValueForTypeStringAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
            ...
            validationResults.AddResults('string', 'Currency', 123456);
