classdef wrongValueForTypeImageAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = wrongValueForTypeImageAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
            ...
            validationResults.AddResults('image', 'newImage', 123456);
