classdef invalidTypeAlgorithm < prursg.BootstrapValidation.BaseBootstrapValidationAlgorithm
    ...
    methods
        function obj = invalidTypeAlgorithm()
        end
        ...
        function validationResults = GenerateBootstrapValidationResults(obj, inputData)
           ...
           validationResults.AddResults('invalidType', 'table1', {1,2,3;'cr',4,'br'});
           %validationResults.AddCustomProperty('invalidType', 'ratetype', 'invalidproperty');
        end
    end
