%% Test_QC2893_03_order_preserved_with_2_axes_alphanumeric
%
...
function Test_QC2893_03_order_preserved_with_2_axes_alphanumeric()
...
% START OF TEST
    % input data series
    dataSeriesName = 'testcase3_axes_alphanumeric';
...
disp('Test_QC2893_03_order_preserved_with_2_axes_alphanumeric() COMPLETE.')
end
