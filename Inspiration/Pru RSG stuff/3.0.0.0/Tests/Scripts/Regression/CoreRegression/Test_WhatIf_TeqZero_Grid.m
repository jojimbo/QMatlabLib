%% Test_WhatIf_TeqZero_Grid
%
% SUMMARY:
%       Regression test for what if T=0 run on grid
%%

function test_suite = Test_WhatIf_TeqZero_Grid() %#ok<STOUT,FNDEF>
    % The first test must return an instance of initTestSuite
    disp('Initialising Test_WhatIf_TeqZero_Grid')
    initTestSuite;
    disp('Executing Test_WhatIf_TeqZero_Grid')
end
...
function Test_WhatIf_TeqZero_Grid1()	%#ok<DEFNU>
