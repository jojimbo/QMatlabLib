...
public class RSGHelper {
	...
	public static void configure(String configName, String testName) throws IOException {
		...
		System.out.println("=========================================================================");
		System.out.println("=========================================================================");
		System.out.println(RSGHelper.timeStamp() + ": Configuring system for test: '" + testName + "'");
		System.out.println("=========================================================================");
		...
		// String logFile = RSGHelper.getLogFileName(testName + "." + configName);
		// MWApplication.initialize(MWMCROption.logFile(logFile), MWMCROption.NODISPLAY);

		RSGHelper.verifyEnv(workingDir);
	}
	
	private static void verifyEnv(String cwd) throws FileNotFoundException {
		// do some basic sanity checking
		File ParallelConfig = new File(cwd, "ParallelConfig.mat");
		if (!ParallelConfig.exists())
			throw new FileNotFoundException(ParallelConfig.toString());
	}
	...
	private static void Simulate(String controlFile, boolean inmem)  throws MWException {
		...
		//String scenarioID = "Test19_11Apr2012_10:17:51";
		
		if (!inmem) {
			System.out.println("Generating files for persistence mode simluation test...");
			RSGHelper.generateFiles(scenarioID);
		} else {
			System.out.println("Explicit file generation for in-memory is not required.");
		}
	
		System.out.println("Comparing for simluation test...");
	...
	public static void CompareFiles(String pathToOutput, String scenarioSetId,
		...
		TestUtilRunner util = null;
		try {
			System.out.println("Preparing to compare files for '" + scenarioSetId + "'");
			List in = RSGHelper
	...
	public static String getLogFileName(String suffix) {
		return RSGHelper.timeStamp() +  ".DeployedRSG" + "." + suffix + ".log";
	}
	...
	private static void cleanup(TestUtilRunner runner) {
		if (runner != null) {
