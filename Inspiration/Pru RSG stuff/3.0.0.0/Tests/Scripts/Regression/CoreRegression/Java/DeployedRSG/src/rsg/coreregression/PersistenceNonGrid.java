...
public class PersistenceNonGrid extends TestCase {
	public void setUp() throws IOException, MWException {
		System.out.println("Setup " + getName());
		RSGHelper.configure("app.config", getName());
	...
	public void testWhatIf_tgt0() throws MWException {
		RSGProxy.RSGSimulate("Test27.xml");
		RSGHelper.runSimulation("Test31.xml");
	}
	...
	public void testBaseSimulation_tgt0() throws MWException {		
		RSGHelper.runSimulation("Test27.xml");
	}	
	...
	/*
	public void test40() throws MWException {	
		// This is not an official test - merely a debugging aid
		RSGHelper.runSimulation("Test40.xml");
	}
	*/
}
