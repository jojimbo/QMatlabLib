...
function test_suite = Test_WI_TeqZero_BB() %#ok<STOUT,FNDEF>
    % The first test must return an instance of initTestSuite
    disp('Initialising Test_WI_TeqZero_BB')
    initTestSuite;
    disp('Executing Test_WI_TeqZero_BB')
end
...
function Test_WI_TeqZero_BB1()	%#ok<DEFNU>
	...
	RSGSimulate('Test20.xml');
    [UserMsg ScenSetID] = RSGSimulate('Test25.xml'); 
