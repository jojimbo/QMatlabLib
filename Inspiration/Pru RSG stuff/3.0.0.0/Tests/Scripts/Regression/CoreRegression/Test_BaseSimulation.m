...
%
% SUMMARY:
%       Regression test for base simulation
%%

function test_suite = Test_BaseSimulation() %#ok<STOUT,FNDEF>
    % The first test must return an instance of initTestSuite
    disp('Initialising Test_BaseSimulation')
    initTestSuite;
    disp('Executing Test_BaseSimulation')
end
...
function Test_BaseSimulation1()	%#ok<DEFNU>
