%% Test_BaseSimulation_Grid
%
% SUMMARY:
%       Regression test for base simulation using the grid
%%

function test_suite = Test_BaseSimulation_Grid() %#ok<STOUT,FNDEF>
    % The first test must return an instance of initTestSuite
    disp('Initialising Test_BaseSimulation_Grid')
    initTestSuite;
    disp('Executing Test_BaseSimulation_Grid')
end
...
function Test_BaseSimulation_Grid1()	%#ok<DEFNU>
    ...
    prursg.Configuration.ConfigurationManager.setConfigFileName('app_grid.config');
