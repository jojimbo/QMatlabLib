%% Unit Test_P20_14_P24_19_4A
% Loading and Pricing of FXIRSwap

function Test_P20_14_P24_19_4A
...
configFilePath = fullfile(pwd, '+Test', filesep, 'Configuration Files', computer, 'configDemo_P24_19_4A(FXIRSw).txt');
