%% Unit Test_P20_14_P24_19_4B
% Loading and Pricing of FXIRSwap

function Test_P20_14_P24_19_4B
...
configFilePath = fullfile(pwd, '+Test', filesep, 'Configuration Files', computer, 'configDemo_P24_19_4B(FXIRSw).txt');
